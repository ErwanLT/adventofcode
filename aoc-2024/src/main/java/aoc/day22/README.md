...
The part about secrets is literal, the Historian explains. Each buyer produces a [pseudorandom](https://en.wikipedia.org/wiki/Pseudorandom_number_generator) sequence of secret numbers where each secret is derived from the previous.
