...
public class Day16 implements Day {
    ...
    public String part2(List<String> input) {
        return String.valueOf(findSum2(input.get(0)));
    }
    ...
    private static long findSum2(String hex) {
        String in = hexToBin(hex.trim());
    ...
    private static List<Long> findPackets2(String in, int toParse) {
        ...
        for(int i = 0, parsed = 0; i< in.length();parsed++){
            ...
            if(id == 4){
                ...
                res.add(binToLongDec(s.toString()));
            } else {
                int lengthLength = 15;
                boolean b = in.charAt(i) == '1';
                if(b){
